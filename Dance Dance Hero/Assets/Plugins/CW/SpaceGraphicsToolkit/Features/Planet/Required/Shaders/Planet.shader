...
Shader "Space Graphics Toolkit/Planet"
{
   Properties
   {
	...
	_DetailFadeBound_Ext_1("	Fade Bound", Float) = 1000.0
   ...
   #pragma fragment Frag
	...
	#pragma shader_feature_local _DETAIL_ON_DEF_1
...
#   define UNITY_LOOP
	...
	void Ext_SurfaceFunction2 (inout Surface o, inout ShaderData d)
	{
		#if __SGT_PLANET_BASE
			#if _DETAIL_ON_DEF_1
				float4 coords     = d.extraV2F1 * _DetailTiling_Ext_1;
				float  max_height = _DetailTiling_Ext_1;
				float  polar      = d.extraV2F0.x;
				float  noise      = sample_noise(coords / 64.0f, polar) - 0.5f;
				float  fade       = saturate(d.blackboard.worldDistance / _DetailFadeRange_Ext_1);

				fade *= saturate((_DetailFadeBound_Ext_1 - d.blackboard.worldDistance) / _DetailFadeBound_Ext_1);

				#if _DETAIL_ALBEDO
					#if _DETAIL_R
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapR, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.r * _DetailScaleR_Ext_1 * fade);
					#endif
					#if _DETAIL_G
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapG, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.g * _DetailScaleG_Ext_1 * fade);
					#endif
					#if _DETAIL_B
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapB, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.b * _DetailScaleB_Ext_1 * fade);
					#endif
					#if _DETAIL_A
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapA, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.a * _DetailScaleA_Ext_1 * fade);
					#endif
				#endif

				#if _DETAIL_NORMAL
					#if _DETAIL_R
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapR, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.r * _DetailScaleR_Ext_1 * fade);
					#endif
					#if _DETAIL_G
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapG, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.g * _DetailScaleG_Ext_1 * fade);
					#endif
					#if _DETAIL_B
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapB, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.b * _DetailScaleB_Ext_1 * fade);
					#endif
					#if _DETAIL_A
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapA, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.a * _DetailScaleA_Ext_1 * fade);
					#endif
				#endif
			#endif
		#endif
