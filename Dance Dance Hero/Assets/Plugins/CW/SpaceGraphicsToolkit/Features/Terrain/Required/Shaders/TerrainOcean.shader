...
#define _USINGTEXCOORD2 1
	...
	void Ext_SurfaceFunction2 (inout Surface o, inout ShaderData d)
	{
				...
				SGT_ContributeDetail(o, _BakedDetailMap_Ext_1, coords, polar, max_height, noise, _BakedDetailScale_Ext_1 * fade);
			#endif
		#endif
	}
	...
	void Ext_SurfaceFunction3 (inout Surface o, inout ShaderData d)
	{
				...
				SGT_ContributeDetail(o, _BakedDetailMap_Ext_2, coords, polar, max_height, noise, _BakedDetailScale_Ext_2 * fade);
			#endif
		#endif
	}
