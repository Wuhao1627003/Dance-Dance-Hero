...
Shader "Space Graphics Toolkit/Terrain Planet"
{
   Properties
   {
	...
	_BakedDetailFadeBound_Ext_1("	Fade Bound", Float) = 1000.0
	...
	_BakedDetailFadeBound_Ext_2("	Fade Bound", Float) = 1000.0
   ...
   #pragma fragment Frag
	...
	#pragma shader_feature_local _BAKEDDETAIL_ON_DEF_1


	#pragma shader_feature_local _BAKEDDETAIL_ON_DEF_2
...
#define _USINGTEXCOORD2 1
	...
	float _BakedDetailFadeBound_Ext_1;
	...
	float _BakedDetailFadeBound_Ext_2;
	...
	void Ext_SurfaceFunction2 (inout Surface o, inout ShaderData d)
	{
				...
				fade *= saturate((_BakedDetailFadeBound_Ext_1 - d.blackboard.worldDistance) / _BakedDetailFadeBound_Ext_1);
				...
				#if _DETAIL_ALBEDO
					#if _DETAIL_R
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapR, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_1 * fade);
					#endif
					#if _DETAIL_G
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapG, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_1 * fade);
					#endif
					#if _DETAIL_B
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapB, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_1 * fade);
					#endif
					#if _DETAIL_A
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapA, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_1 * fade);
					#endif
				#endif

				#if _DETAIL_NORMAL
					#if _DETAIL_R
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapR, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_1 * fade);
					#endif
					#if _DETAIL_G
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapG, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_1 * fade);
					#endif
					#if _DETAIL_B
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapB, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_1 * fade);
					#endif
					#if _DETAIL_A
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapA, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_1 * fade);
					#endif
				#endif
			#endif
		#endif
	...
	void Ext_SurfaceFunction3 (inout Surface o, inout ShaderData d)
	{
				...
				fade *= saturate((_BakedDetailFadeBound_Ext_2 - d.blackboard.worldDistance) / _BakedDetailFadeBound_Ext_2);
				...
				#if _DETAIL_ALBEDO
					#if _DETAIL_R
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapR, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_2 * fade);
					#endif
					#if _DETAIL_G
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapG, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_2 * fade);
					#endif
					#if _DETAIL_B
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapB, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_2 * fade);
					#endif
					#if _DETAIL_A
						ContributeDetailA(o, TEXTURE2D_ARGS(_AlbedoMapA, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_2 * fade);
					#endif
				#endif

				#if _DETAIL_NORMAL
					#if _DETAIL_R
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapR, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_2 * fade);
					#endif
					#if _DETAIL_G
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapG, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_2 * fade);
					#endif
					#if _DETAIL_B
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapB, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_2 * fade);
					#endif
					#if _DETAIL_A
						ContributeDetailN(o, TEXTURE2D_ARGS(_NormalMapA, sampler_linear_repeat), coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_2 * fade);
					#endif
				#endif
			#endif
		#endif
